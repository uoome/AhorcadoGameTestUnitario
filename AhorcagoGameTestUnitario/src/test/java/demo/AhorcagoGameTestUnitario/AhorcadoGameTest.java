package demo.AhorcagoGameTestUnitario;
...
public class AhorcadoGameTest {
	...
	@Test	
	public void palabra_perro_ingreso_caracter_vacio_quita_una_vida() {
		// Act
		partidaActual.guess("");
	...
	@Test
	public void palabra_perro_ingreso_letra_a_quita_una_vida() {
		// Act
	...
	@Test
	public void palabra_perro_ingreso_letra_p_no_quita_vida() {
		// Act
	...
	@Test
	public void palabra_perro_perder_juego_errando_todas_las_letras() {		
		// Arrange
	...
	@Test
	public void palabra_perro_ganar_al_adivinar_todas_las_letras() {
		// Arrange
	...
	@Test
	public void ingresar_nombre_jugador_vacio_devuelve_falso() {		
		// Arrange 
	...
	@Test
	public void ingresar_nombre_jugador_devuelve_true() {		
		// Arrange 
		Jugador player = new Jugador();
		boolean rta;
	...
	@Test
	public void ingresar_nombre_jugador_Nico_devuelve_Nico() {		
		// Arrange 
		Jugador player = new Jugador();
	...
	@Test
	public void generar_palabra_harcodeada_se_encuentra_en_alfabeto() {
		// Arrange
		String palabraHarco;
		boolean rta = false;
	...
	@Test
	public void palabra_perro_ganar_de_primera_devuelve_score_10() {
		// Arrange
		String cadena[] = {"p","e","r","o"};
	...
	@Test
	public void palabra_perro_ganar_errando_3_letras_devuelve_score_7() {
		// Arrange
	...
	@Test
	public void mostrar_tiempo_de_juego_devuelve_tiempo_transcurrido () {
		// Arrange
	...
	@Test
	public void palabra_perro_adivinar_letra_e_muestra_palabra_con_letra_e(){
		// Arrange
	...
	@Test
	public void palabra_perro_adivinar_letras_e_y_r_muestra_palabra_con_letras(){
		// Arrange
		partidaActual.setWordToDisplay("*****");
